              ...
              <div class="card-body">
                <form role="form" method="post" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" name="kullaniciGiris" class="btn bg-gradient-primary w-100 my-4 mb-2">Giriş Yap</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                    <a href="kayitOl.php" class="text-primary text-gradient font-weight-bold">Üye Ol</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                © 
                made with <i class="fa fa-heart" aria-hidden="true"></i> by Nurhak Keskin
              </div>
            </div>
          </div>
        </div>
